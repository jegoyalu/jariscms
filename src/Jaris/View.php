 ...
 */
     ...
     * @var array
     */
    public static $tabs_list = [];

    /**
     * Additional styles added to the final page.
     * @var array
     */
    public static $additional_styles = [];
     ...
     */
    public static function loadThemeSettings(): void
    {
        $theme = Site::$theme;
     ...
     */
    public static function addStyle(string $path, array $arguments = []): void
    {
     ...
     */
    public static function addScript(string $path, array $arguments = []): void
    {
        $current_url = Uri::url($path, $arguments);
     ...
     * @param array $arguments Arguments if the css file is dynamic.
     */
    public static function addSystemStyle(string $path, array $arguments = []): void
    {
     ...
     * @param array $arguments Arguments if the javascript file is dynamic.
     */
    public static function addSystemScript(string $path, array $arguments = []): void
    {
     ...
     */
    public static function addStyleCode(string $code): void
    {
     ...
     */
    public static function addScriptCode(string $code): void
    {
     ...
     */
    public static function addMessage(string $message, string $type = "normal"): void
    {
        Session::start();
     ...
     */
    public static function getMetaTagsHTML(?array &$page_data=[]): string
    {
        if (!$page_data) {
     ...
     */
    public static function getContentHTML(array $content_list, string $page): string
    {
        $theme = Site::$theme;
     ...
     * block template.
     */
    public static function getBlocksHTML(
    array $arrData,
    string $position,
    string $page
): string {
     ...
     */
    public static function getContentBlocksHTML(
    array $arrData,
    string $position,
    string $page,
    string $page_type
                ...
                if (Blocks::userHasAccess($field)) {
                    if (Blocks::pageHasAccess($field, $page)) {
                        ...
                        Authentication::groupHasPermission(
                            ...
                            $url = Uri::url("admin/pages/blocks/edit", ["uri" => $page, "id" => $id, "position" => $position]);
     ...
     */
    public static function getLinksHTML(array $arrLinks, string $menu_name): string
    {
        $position = 1;
     ...
     */
    public static function getStylesHTML(array $styles): string
    {
        $theme = Site::$theme;
     ...
     * @return string Html code for the head section of document.
     */
    public static function getScriptsHTML(array $scripts): string
    {
        $theme = Site::$theme;
...
SCRIPT;
     ...
     */
    public static function getTabsHTML(array $tabs_array): string
    {
     ...
     * @return string html code ready to render or empty string.
     */
    public static function getMessagesHTML(): string
    {
        if (!Session::exists()) {
            return "";
        }
     ...
     */
    public static function blockTemplate(string $position, string $page, int $id): string
    {
        $theme = Site::$theme;
     ...
     */
    public static function contentBlockTemplate(
    string $position,
    string $page,
    string $page_type,
    int $id
     ...
     */
    public static function pageTemplate(string $page): string
    {
        $theme = Site::$theme;
        $page = str_replace("/", "-", $page);
        ...
        if (file_exists($current_page)) {
            $template_path = $current_page;
        } elseif ($one_less_section && file_exists($globa_sections_page)) {
     ...
     */
    public static function contentTemplate(string $page, string $type): string
    {
        $theme = Site::$theme;
        $page = str_replace("/", "-", $page);
     ...
     */
    public static function userProfileTemplate(string $group, string $username): string
    {
        $theme = Site::$theme;
    ...
    string $page,
    string $results_type="all",
    string $template_type="result"
): string {
        $theme = Site::$theme;
        $page = str_replace("/", "-", $page);
