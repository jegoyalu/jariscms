 ...
 */
    public static function contentPreview(
    string $string,
    int $word_count=30,
     ...
     */
    public static function directoryBrowser(string $directory): array
    {
        $main_dir = $directory . "/";
        ...
        while (($file = readdir($dir_handle)) !== false) {
            ...
            if (strcmp($file, ".") != 0 && strcmp($file, "..") != 0) {
                if (is_dir($main_dir . $file)) {
                    $dir_array[] = ["main" => $main_dir, "dir" => $file];
                }
            }
        }
     ...
     */
    public static function generateBrowserNavigation(
    array $directories,
    string $main_dir
): array {
        $navigation = [];
