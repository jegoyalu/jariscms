 ...
 */
     ...
     */
    public static function sendPasswordNotification(
    string $username,
    array $user_data
): bool {
     ...
     */
    public static function sendRegistrationNotification(string $username): bool
    {
        ...
        Uri::url("admin/user", ["return" => "admin/users/list"]) .
        "\">" . Uri::url("admin/user", ["return" => "admin/users/list"]) .
        "</a>"
    ;
     ...
     * @param string $type
     */
    public static function sendContentApproveNotification(string $uri, string $type): bool
    {
        ...
        $html_message .= "<a target=\"_blank\" href=\"" .
        Uri::url("admin/user", ["return" => "admin/pages/approve"]) .
        "\">" . Uri::url("admin/user", ["return" => "admin/pages/approve"]) .
        "</a>"
    ;
     ...
     */
    public static function sendEmailActivation(string $username_or_email): bool
    {
        $user_data = [];
     ...
     * @return bool True on success or false on failing to send the email.
     */
    public static function sendWelcomeMessage(string $username_or_email): bool
    {
