 ...
 */
     ...
     */
    public static function add(string $machine_name, array $data): string
    {
     ...
     */
    public static function delete(string $machine_name): bool
    {
        $path = self::getPath($machine_name);
     ...
     * @return bool True on success or false on fail.
     */
    public static function edit(string $machine_name, array $new_data): bool
    {
        $path = self::getPath($machine_name);
     ...
     */
    public static function get(string $machine_name): array
    {
        static $data;
     ...
     * @return bool True on success or false on fail.
     */
    public static function addSubcategory(string $category, array $data): bool
    {
     ...
     */
    public static function getSubcategory(string $category, int $id): array
    {
        if ($id === null) {
            return [];
        }
     ...
     */
    public static function getChildSubcategories(
    string $category,
    $parent_id = "root"
): array {
        $subcategories = self::getSubcategories($category);

        $subcategory_childrens = [];
        if ($subcategories) {
    ...
    public static function getSubcategories(string $category): array
    {
        ...
        if (!isset($categories[$category])) {
            ...
            if (!isset($category_data["sorting"]) || !$category_data["sorting"]) {
                ...
                Data::parse($path . "/sub_categories.php"),
                "order"
            );
            } else {
                $categories[$category] = Data::sort(
     ...
     */
    public static function getSubcategoriesInParentOrder(
    string $category_name,
    string $parent = "root",
    string $position = "",
    bool $with_content = false
): array {
        static $content_count = [];
     ...
     */
    public static function addBlock(string $machine_name, array $data): void
    {
        $category_block = [];
     ...
     */
    public static function showResults(string &$page): void
    {
     ...
     */
    public static function createContentCountDb(): void
    {
        static $exists = false;
     ...
     */
    public static function populateContentCount(string $category=""): void
    {
     ...
     * @return void
     */
    public static function incrementContent(array $categories): void
    {
        static $exists = false;
     ...
     * @return void
     */
    public static function decrementContent(array $categories): void
    {
        static $exists = false;
     ...
     */
    public static function getPath(string $machine_name): string
    {
