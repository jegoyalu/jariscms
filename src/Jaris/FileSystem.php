 ...
 */
     ...
     */
    public static function move(string $source, string $destination): string
    {
        //Strip any special characters from filename
        $name = explode("/", $destination);
     ...
     */
    public static function renameIfExist(string $file_name): string
    {
        $file_index = 0;
     ...
     */
    public static function search(string $path, string $pattern, callable $callback): bool
    {
     ...
     */
    public static function recursiveMoveDir(string $source, string $target): bool
    {
     ...
     * @return bool true on success or false on fail.
     */
    public static function recursiveCopyDir(string $source, string $target): bool
    {
        $source_dir = opendir($source);
     ...
     */
    public static function recursiveRemoveDir(
    string $directory,
    bool $empty = false
): bool {
     ...
     */
    public static function stripExtension(
    string $filename,
    ?string &$extension = ""
): string {
     ...
     * application/octet-stream if not possible to retreive data.
     */
    public static function getMimeTypeLocal(string $filename): string
    {
        $mime_types = [
        'txt' => 'text/plain',
        'htm' => 'text/html',
