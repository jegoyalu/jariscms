 ...
 */
    public static function add(string $menu_name): string
    {
     ...
     */
    public static function delete(string $menu_name): bool
    {
        $menu_file = self::getPath($menu_name);
     ...
     */
    public static function rename(string $actual_name, string $new_name): string
    {
     ...
     * @return bool True on success or false on fail.
     */
    public static function addItem(string $menu_name, array $fields): bool
    {
     ...
     */
    public static function deleteItem(int $id, string $menu_name): bool
    {
        $menu_data_path = self::getPath($menu_name);
     ...
     */
    public static function editItem(int $id, string $menu_name, array $new_data): bool
    {
        $menu_data_path = self::getPath($menu_name);
     ...
     */
    public static function getItem(int $id, string $menu_name): array
    {
        $menu_data_path = self::getPath($menu_name);
     ...
     */
    public static function getItemsList(string $menu_name): array
    {
        static $menu_array = [];
     ...
     */
    public static function getChildItems(
    string $menu_name,
    $parent_id = "root"
): array {
     ...
     */
    public static function getSecondaryName(): string
    {
     ...
     */
    public static function getPath(string $menu): string
    {
