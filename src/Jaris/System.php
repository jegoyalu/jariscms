 ...
 */
     ...
     */
    public static function pageNotFound(): array
    {
        ...
        $page_type != "category"
            ...
            Authentication::userHasPermissions(
                ["view_content", "add_content"]
            )
        ) {
                $tabs[t("Create Page")] = [
                "uri" => "admin/pages/types",
                "arguments" => ["uri" => Uri::get()]
            ];
            }
        }
     ...
     * @return string
     */
    public static function getStyleUrl(string $path, array $args = []): string
    {
     ...
     * @return string
     */
    public static function getScriptUrl(string $path, array $args = []): string
    {
     ...
     * specified.
     */
    public static function pagesBlackList(string $check_path = "")
    {
        static $list = null;
     ...
     */
    public static function checkIfNotInstalled(): void
    {
     ...
     */
    public static function errorMessage(string $type = ""): string
    {
        $message = "";
        $message_orig = "";
     ...
     */
    public static function isSSLSupported(): bool
    {
        $base_url = Site::$base_url;
     ...
     */
    public static function isSSLConnection(): bool
    {
     ...
     */
    public static function addEditTab(?array &$page_data=[]): void
    {
        $uri = Uri::get();
        ...
        !Pages::isSystem("", $page_data)
            ...
            if (Pages::userIsOwner($uri, $page_data)) {
                View::addTab(t("Edit"), "admin/pages/edit", ["uri" => $uri]);
     ...
     */
    public static function evalPHP(?string $text, ?bool &$eval_return=false): string
    {
     ...
     */
    public static function initiateErrorCatchSystem(): void
    {
        ...
        set_error_handler(['\Jaris\System', 'errorCatchHook']);

        set_exception_handler(['\Jaris\System', "exceptionCatchHook"]);
    }
     ...
     * @return bool
     */
    public static function errorCatchHook(
    int $errno,
    string $errmsg,
    string $filename,
    int $linenum,
     ...
     * @return void
     */
    public static function exceptionCatchHook($e): void
    {
     ...
     * @return array
     */
    public static function generateAdminPageSections(): array
    {
     ...
     * )
     */
    public static function generateAdminPage(array $sections): void
    {
     ...
     */
    public static function generateBreadcrumb(string $separator = "&gt;"): string
    {
     ...
     */
    public static function addHiddenUrlParameters(
    array $parameters,
    string $type = "get"
): void {
     ...
     * $_REQUEST variable.
     */
    public static function appendHiddenParameters(): void
    {
     ...
     */
    public static function cachePageIfPossible(string $uri, array $page_data): void
    {
        if (
        !$page_data["is_system"] &&
     ...
     */
    public static function fastCacheIfPossible(string $uri): void
    {
        if (
     ...
     */
    public static function savePageToCacheIfPossible(
    string $uri,
    array $page_data,
    string $content
): string {
     ...
     */
    public static function removeCachedPage(string $uri, ?array &$get_params=[]): bool
    {
        $cache_file = Site::dataDir() . "cache/" .
        Uri::fromText($_SERVER["HTTP_HOST"] . $uri) . Language::getCurrent()
    ;
