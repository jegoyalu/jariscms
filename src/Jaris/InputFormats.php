 ...
 */
     ...
     */
    public static function parseEmails(string $text): string
    {
     ...
     */
    public static function parseLineBreaks(string $text): string
    {
        return nl2br($text);
    }
     ...
     */
    public static function filter(string $data, string $input_format): string
    {
