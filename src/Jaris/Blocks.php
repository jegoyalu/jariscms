 ...
 */
     ...
     * @return bool true on success false on fail.
     */
    public static function delete(int $id, string $position, string $page = ""): bool
    {
     ...
     * @return bool True on success false on fail.
     */
    public static function deleteByField(
    string $field_name,
    string $value,
    string $page = "",
     ...
     */
    public static function editByField(
    string $field_name,
    string $value,
    array $new_data,
    string $page = "",
     ...
     */
    public static function get(int $id, string $position, string $page = ""): array
    {
        $block_data_path = self::getPath($position, $page);
     ...
     */
    public static function getTranslated(?array &$data, string $language_code): bool
    {
        if (isset($data["id"])) {
     ...
     */
    public static function getList(string $position, string $page = ""): array
    {
        $block_data_path = self::getPath($position, $page);
     ...
     */
    public static function userHasAccess(array $block): bool
    {
     ...
     */
    public static function pageHasAccess(array $block, string $page): bool
    {
        ...
        } elseif ($block["display_rule"] == "just_listed") {
            foreach ($pages as $page_check) {
                $page_check = trim($page_check);
     ...
     */
    public static function setPostSettings(array $settings, string $page): bool
    {
     ...
     */
    public static function getPostSettings(string $page): array
    {
        $settings_path = Pages::getPath($page) . "/blocks/post_settings.php";
     ...
     */
    public static function generatePostContent(string $uri, string $page_uri): array
    {
     ...
     * @param ?array $footer
     */
    public static function moveByTheme(
    ?array &$header,
    ?array &$left,
    ?array &$right,
    ?array &$center,
     ...
     * @return array
     */
    public static function generateThemesSelect(array $selected=[]): array
    {
        $fields = [];
     ...
     */
    public static function getPath(string $position, string $page = ""): string
    {
        $block_path = "";
