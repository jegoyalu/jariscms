 ...
 */
     ...
     * @param string $page The page uri where the image reside.
     */
    public static function deleteByName(string $name, string $page): void
    {
     ...
     */
    public static function get(&$id, string $page): array
    {
        $image_data_path = self::getPath($page);
     ...
     */
    public static function getList(string $page, bool $skip_disabled=true): array
    {
        $image_data_path = self::getPath($page);
