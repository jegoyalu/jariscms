 ...
 */
     ...
     */
    public static function delete(int $id, string $page): bool
    {
        $file_data_path = self::getPath($page);
     ...
     */
    public static function deleteByName(string $name, string $page): bool
    {
        $file_data_path = self::getPath($page);
     ...
     * @return bool True on success false on fail.
     */
    public static function edit(int $id, array $new_data, string $page): bool
    {
        $file_data_path = self::getPath($page);
     ...
     */
    public static function editByName(string $name, array $new_data, string $page): bool
    {
     ...
     */
    public static function get(int $id, string $page): array
    {
        $file_data_path = self::getPath($page);
     ...
     * @return array All the fields of the file.
     */
    public static function getByName(string $name, string $page): array
    {
        static $page_name, $files;
     ...
     */
    public static function getList(string $page): array
    {
        $file_data_path = self::getPath($page);
     ...
     */
    public static function printIt(string $file_uri): void
    {
