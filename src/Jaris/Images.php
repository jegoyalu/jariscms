 ...
 */
    public static function show(string $image_path): void
    {
     ...
     */
    public static function getCacheName(string $original_image=""): string
    {
        $page = Uri::get();
     ...
     */
    public static function getStaticName(string $image_url, bool $full_url=true): string
    {
    ...
    string $background_color = "ffffff"
        ...
        } elseif ($width > 0 && $height > 0 && $aspect_ratio) {
            $image_data["binary_data"] = imagecreatetruecolor($width, $height);
            self::makeTransparent($image_data["binary_data"], $image_data["mime"]);
     ...
     */
    public static function makeTransparent(&$image, string $mime): void
    {
        switch ($mime) {
        case "image/png":
        case "image/gif":
     ...
     */
    public static function printIt(array $image): void
    {
        $page = Uri::get();
     ...
     */
    public static function printCached(string $path): void
    {
     ...
     */
    public static function printUserPic(string $page): void
    {
     ...
     */
    public static function hexToRGB(string $value): array
    {
        return [
