 ...
 */
     ...
     */
    public static function add(string $page, array $data, ?string &$uri): bool
    {
        $page = trim($page);
        if ($page == "") {
            return false;
        ...
        if (Data::add($data, $path . "/data.php")) {
            ...
            Categories::incrementContent($categories ?? []);
     ...
     * @return bool True on success or false on fail.
     */
    public static function delete(string $page, bool $disable_hook=false): bool
    {
        $page = trim($page);
        if ($page == "") {
            return false;
        ...
        Categories::decrementContent($page_data["categories"] ?? []);
     ...
     * @return bool True on success or false on fail.
     */
    public static function edit(string $page, array $new_data): bool
    {
        $page = trim($page);
        if ($page == "") {
            return false;
     ...
     * @return bool True on success or false on fail.
     */
    public static function approve(string $page): bool
    {
        $page = trim($page);
        if ($page == "") {
            return false;
     ...
     */
    public static function countView(string $page): int
    {
     ...
     * @return int The total count of page views.
     */
    public static function getViews(string $page): int
    {
     ...
     */
    public static function get(string $page, string $language_code = ""): array
    {
     ...
     */
    public static function getType(string $page): string
    {
        $page = trim($page);
        if ($page == "") {
            return "";
     ...
     */
    public static function userIsOwner(string $page, ?array &$page_data=[]): bool
    {
        $page = trim($page);
        if ($page == "") {
            return false;
     ...
     */
    public static function move(string $actual_uri, ?string &$new_uri): bool
    {
     ...
     */
    public static function isSystem(string $uri = "", ?array &$page_data=[]): bool
    {
        $page = Uri::get();
     ...
     */
    public static function userHasAccess(array $page_data): bool
    {
        if (Authentication::isAdminLogged()) {
            return true;
        }
     ...
     */
    public static function removeEmptyDirectories(string $path): bool
    {
        $path = trim($path);
     ...
     */
    public static function addIndex(string $uri, array $data): void
    {
        static $exists = false;
     ...
     */
    public static function editIndexUri(string $old_uri, string $new_uri): void
    {
        static $exists = false;
     ...
     */
    public static function editIndex(string $uri, array $data): void
    {
        static $exists = false;
     ...
     */
    public static function deleteIndex(string $uri)
    {
        static $exists = false;
     ...
     */
    public static function getPath(string $page): string
    {
     ...
     */
    public static function getSystemPath(string $page): string
    {
