function reposition_block_edit_button()
{
    $(".instant-block-edit, .instant-content-block-edit").each(function(index){
        ...
        var left = parseInt(
            position.left
            +
            $(this).parent().innerWidth()-$(this).innerWidth()
        );
        ...
        $(this)
            .parent()
            .children(".instant-block-edit-container")
...
$(document).ready(function() {
    ...
    $(".instant-block-edit, .instant-content-block-edit").each(function(index){
        ...
        if($(this).parent().parent().parent().get(0).nodeName == "TD"){
