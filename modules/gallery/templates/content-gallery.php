            ...
            <td class="content">
                ...
                <?php
                    ...
                    for($i=0; $i<count($images_to_show); $i++)
                    {
                        ...
                        print "<a class=\"lightbox\" rel=\"gallery\" title=\" " . t($images[$images_to_show[$i]]["description"]) . "\" href=\"" . Jaris\Uri::url("image/" . Jaris\Uri::get() . "/" . $images[$images_to_show[$i]]["name"]) . "\"><img style=\"border: solid #666666 2px\" src=\"" . Jaris\Uri::url("image/" . Jaris\Uri::get() . "/" . $images[$images_to_show[$i]]["name"], array("w"=>$content_data["thumbnails_width"],"h"=>$content_data["thumbnails_height"], "ar"=>$content_data["aspect_ratio"], "bg"=>$content_data["background_color"])) . "\" /></a>\n";
                        print "</div>";
                    ...
                    $anterior_enlace = ($position > 1)?Jaris\Uri::url(Jaris\Uri::get(), array("position"=>$position-1)):"javascript:void(0)";
                    $despues_enlace = ($pages > 1 && $position != $pages)?Jaris\Uri::url(Jaris\Uri::get(), array("position"=>$position+1)):"javascript:void(0)";
