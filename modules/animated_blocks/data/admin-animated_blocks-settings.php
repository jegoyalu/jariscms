 ...
 *
 *Database file that stores the animated block settings and effects page.
 */
...
row: 0
    ...
    <?php
        ...
        )
        {
            ...
            $block_data["effects"]["image_as_background_keep_ar"] = $_REQUEST["image_as_background_keep_ar"];
        ...
        $fields_area[] = array(
            ...
            "name"=>"auto_info",
            "id"=>"auto_info",
            "label"=>t("Autogenerate information?"),
            "value"=>$true_false,
