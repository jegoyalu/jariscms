...
row: 0
    ...
    <form class="church-attendance-courses-delete" method="post"
    ...
    >
        ...
        <div>
            ...
            <p>
                <?php
                    print t("Deleting a course will affect all associations for existing members.");
                    print t("Are you sure you want to delete this course?");
                ?>
            </p>
            <div>
                <b>
