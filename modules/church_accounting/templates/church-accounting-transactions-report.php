...
if (
    ...
    while ($data = Jaris\Sql::fetchArray($result_expenses)) {
        ...
        print "<td class=\"credit\">$" . number_format($data["total"], 2, ".", ",") . "</td>";
    ...
    print "<tr>";
    print "<td></td>";
    print "<td style=\"text-align: right\"><strong>".t("Total:")."</strong></td>";
    print '<td class="credit">$' . number_format($total_expenses, 2, ".", ",") . "</td>";
    ...
    print "<tr>";
    print "<td></td>";
    print "<td style=\"text-align: right\"><strong>".t("Net Total:")."</strong></td>";
    print '<td colspan="2">';
    print "<p class=\"total\">"
