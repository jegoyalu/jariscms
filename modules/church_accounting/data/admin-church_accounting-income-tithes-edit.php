...
row: 0
    ...
    <?php
        ...
        $tither_data = church_accounting_tither_get($offerings_data["tither"]);
        ...
        if (
            ...
            !Jaris\Forms::requiredFieldEmpty("edit-income-tithe")
        ) {
            $data = $offerings_data;
            ...
            Jaris\View::addMessage(t("Tithe successfully edited."));
        ...
        $parameters["name"] = "edit-income-tithe";
        $parameters["class"] = "edit-income-tithe";
