...
row: 0
    field: title
        <?php print t("Delete Income Category") ?>
    field;
    ...
    <?php
        ...
        if(isset($_REQUEST["btnYes"]))
        {
            ...
            church_accounting_income_move_to_other($element_data["id"]);

            Jaris\View::addMessage(t("Income category successfully deleted."));
    ...
    <form class="church-accounting-income-category-delete" method="post"
    ...
    >
        ...
        <div>
            ...
            <p>
                <?php
                    print t("Deleting an income category will affect all associations for existing income.");
